...
impl OpenApiGenerator {
    /// Generate complete OpenAPI 3.1 JSON specification for registered schemas
    pub fn generate_spec(schemas: &SchemaRegistry) -> Value {
        ...
        json!({
            ...
            "info": {
                "title": "Oxide_CG dAPI",
                "version": "1.0.0",
                "description": "High-performance, auto-generated RESTful API powered by Oxide_CG (Rust + React)."
            },
            "paths": paths,
            "components": {
...
<head>
  ...
  <title>Oxide_CG dAPI Documentation</title>
